 ...
 * @param print_segments Pointer to boolean flag for printing the program segments
...
/**
 * @brief Prints the register from a Y86 instruction (helper)
 *
 * @param inst Y86 instruction register to be printed
 */
void check_reg (y86_regnum_t reg);

/**
 * @brief Prints the dest from a Y86 instruction (helper)
 *
 * @param inst Y86 instruction dest to be printed
 */
